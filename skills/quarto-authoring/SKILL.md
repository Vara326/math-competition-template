...
description: >
  ...
  YAML metadata configuration, and Quarto extensions. Also covers converting
  R Markdown (.Rmd), bookdown, blogdown, xaringan, and distill projects to
  Quarto, and creating Quarto websites, books, presentations, and reports.
  Do not use this skill when the user wants to create or edit R Markdown (.Rmd)
  files — only use it for Quarto (.qmd) authoring or for converting to Quarto.
metadata:
